...
const WC_MATCHES_DONE = [
  ...
  // Demi-finales
  {g:'KOD',d:'14 juil.',t1:'France',t2:'Espagne',s1:0,s2:2},
  {g:'KOD',d:'15 juil.',t1:'Angleterre',t2:'Argentine',s1:1,s2:2},
  // 3e place
  {g:'KOF',d:'18 juil.',t1:'France',t2:'Angleterre',s1:4,s2:6},
  // Finale
  {g:'KOF',d:'19 juil.',t1:'Espagne',t2:'Argentine',s1:1,s2:0,pen:'a.p.'}
];

const WC_MATCHES_UPCOMING = [
  // Compétition terminée — 19 juillet 2026
];
...
function renderWorldCup(fc){
  ...
  var mh=[[
    ...
    ['1 juil.','18h00','Angleterre','RD Congo','2-1']
  ]];
  // Moitié Basse — 16es de finale
  var mb2=[[
    ['1 juil.','22h00','Belgique','Sénégal','3-2 (a.p.)'],
    ['2 juil.','02h00','États-Unis','Bosnie-Herzégovine','2-0'],
    ['2 juil.','21h00','Espagne','Autriche','3-0'],
  ...
  h+='<div class="bcolD">'+mbr('14 juil.','21h00','France','Espagne','0-2')+'</div></div>';
  ...
  // ═══ CENTRE → FINALE ═══
  h+='<div class="bcenter"><div class="kofinal"><div class="kofstars">★ ★ ★ ★ ★</div><div class="koftitle">🏆 ESPAGNE</div><div class="kofvs">1-0 (a.p.) · Argentine</div><div class="kofvenue">MetLife Stadium · 19 juillet</div></div></div>';
  ...
  h+='<div class="brow">';
  h+='<div class="bcolD">'+mbr('15 juil.','21h00','Angleterre','Argentine','1-2')+'</div>';
  ...
  h+='<div class="kothirdvs">France 4-6 Angleterre</div></div>';
  h+='</section>';
  ...
  h+='<div style="text-align:center;padding:40px;color:rgba(0,0,0,.3);font-size:.68rem">Dernière mise à jour : 25 juillet 2026</div>';
  fc.innerHTML=h;
}
