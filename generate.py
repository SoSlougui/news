...
.dark{
--bg:#1a1a1e;--bg2:#212126;--card:#25252b;--cardh:#2a2a31;
--border:rgba(255,255,255,.07);--text:#e8e8ed;--text2:#a8a8b0;--text3:#5c5c66;
--hero-bg:linear-gradient(135deg,#1e1e24,#22222a);
--shadow:none;--shadowh:0 12px 40px rgba(0,0,0,.25);
}
...
.feed-col{flex:1;overflow-y:auto;padding:24px 36px;min-width:0;transition:flex .3s}
...
/* Section titles */
.sec-label{font-size:.62rem;text-transform:uppercase;letter-spacing:2px;color:var(--text3);font-weight:600;margin-bottom:14px}

/* Hero */
.hero{display:flex;flex-direction:row;border-radius:16px;overflow:hidden;background:var(--card);border:1px solid var(--border);transition:all .3s;margin-bottom:28px;cursor:pointer;min-height:240px}
.hero:hover{box-shadow:var(--shadowh)}
.hero-img{flex:0 0 48%;overflow:hidden;position:relative}
.hero-img img{width:100%;height:100%;object-fit:cover;position:absolute;top:0;left:0}
.hero-body{flex:1;padding:22px 26px;display:flex;flex-direction:column;justify-content:center;overflow:hidden}
...
.hero-title{font-size:1.1rem;font-weight:800;line-height:1.22;color:var(--text);margin-bottom:8px;font-family:Georgia,'Times New Roman',serif;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden}
...
.card-img{height:150px;overflow:hidden;flex-shrink:0;background:var(--bg2)}
...
.hero{flex-direction:column;min-height:auto}.hero-img{flex:0 0 200px;position:relative}.hero-img img{position:absolute;top:0;left:0;width:100%;height:100%}.hero-body{padding:16px 20px}
...
.hero-img{flex:0 0 170px;position:relative}.hero-img img{position:absolute;top:0;left:0;width:100%;height:100%}
