...
const WC_GROUPS = {
  A:{name:'Groupe A',teams:[
    {team:'Mexique',flag:'🇲🇽',p:7,gf:6,ga:0,pl:3},
    {team:'Afrique du Sud',flag:'🇿🇦',p:4,gf:2,ga:3,pl:3},
    {team:'Coree du Sud',flag:'🇰🇷',p:3,gf:2,ga:3,pl:3},
    {team:'Republique Tcheque',flag:'🇨🇿',p:1,gf:2,ga:6,pl:3}
  ]},
  B:{name:'Groupe B',teams:[
    {team:'Suisse',flag:'🇨🇭',p:7,gf:7,ga:3,pl:3},
    {team:'Canada',flag:'🇨🇦',p:4,gf:8,ga:3,pl:3},
    {team:'Bosnie-Herzegovine',flag:'🇧🇦',p:4,gf:5,ga:6,pl:3},
    {team:'Qatar',flag:'🇶🇦',p:1,gf:2,ga:10,pl:3}
  ]},
  C:{name:'Groupe C',teams:[
    {team:'Bresil',flag:'🇧🇷',p:7,gf:7,ga:1,pl:3},
    {team:'Maroc',flag:'🇲🇦',p:7,gf:6,ga:3,pl:3},
    {team:'Ecosse',flag:'🏴󠁧󠁢󠁳󠁣󠁴󠁿',p:3,gf:1,ga:4,pl:3},
    {team:'Haiti',flag:'🇭🇹',p:0,gf:2,ga:8,pl:3}
  ]},
  D:{name:'Groupe D',teams:[
    {team:'Etats-Unis',flag:'🇺🇸',p:6,gf:8,ga:4,pl:3},
    {team:'Australie',flag:'🇦🇺',p:4,gf:2,ga:2,pl:3},
    {team:'Paraguay',flag:'🇵🇾',p:4,gf:2,ga:4,pl:3},
    {team:'Turkiye',flag:'🇹🇷',p:3,gf:3,ga:5,pl:3}
  ]},
  E:{name:'Groupe E',teams:[
    {team:'Cote d\'Ivoire',flag:'🇨🇮',p:6,gf:4,ga:2,pl:3},
    {team:'Allemagne',flag:'🇩🇪',p:6,gf:10,ga:4,pl:3},
    {team:'Equateur',flag:'🇪🇨',p:4,gf:2,ga:2,pl:3},
    {team:'Curacao',flag:'🇨🇼',p:1,gf:1,ga:9,pl:3}
  ]},
  F:{name:'Groupe F',teams:[
    {team:'Pays-Bas',flag:'🇳🇱',p:7,gf:10,ga:4,pl:3},
    {team:'Japon',flag:'🇯🇵',p:5,gf:7,ga:3,pl:3},
